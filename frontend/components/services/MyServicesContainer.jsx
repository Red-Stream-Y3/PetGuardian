...
const MyServicesContainer = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ThemeOverlay visible={showAccept} onPressBg={() => setShowAccept(false)}>
        <ThemeCard>
          <View style={{}}>
            ...
            <View style={styles.buttonContainer}>
              ...
              />
              <ThemeButton title={'Accept'} onPress={handleAcceptClick}>
                {buttonLoading && (
                  <ActivityIndicator
                    size={16}
      ...
      <ThemeOverlay visible={showReject} onPressBg={() => setShowReject(false)}>
        <ThemeCard>
          <View style={{}}>
            <Text style={styles.textTitle}>
            ...
            <View style={styles.buttonContainer}>
              ...
              />
              <ThemeButton title={'Reject'} onPress={handleRejectClick}>
                {buttonLoading && (
                  <ActivityIndicator
                    size={16}
                    color={theme.colors.primarytext}
