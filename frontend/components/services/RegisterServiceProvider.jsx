...
const RegisterServiceProvider = ({ navigation, existing }) => {
  ...
  //initialize values from user if existing===true
  useEffect(() => {
    if (existing) {
      setServiceList(user.services.serviceTypes);
      setPetTypeList(user.services.petTypes);

      setDays(
        user.services.workDays.map((day) => {
          if (day) return true;
          return false;
        })
      );
      setPhoneList(user.services.businessPhone);
      setCityList(user.services.activeCities);
      setFees(user.services.fees);
      setDescription(user.services.description);
    }
  }, [existing]);
  ...
  const handleSubmitClick = async () => {
    ...
    const data = {
      ...
      update: existing === true ? true : false,
    };
  ...
  return (
    ...
    >
      ...
      >
        {!showRegister && (existing === false || existing === undefined) && (
          <Animated.View
            entering={FadeInDown}
            exiting={FadeOutUp}
            style={styles.registerContainer}
          >
            <Text style={styles.text}>Do you provide any pet services? </Text>
            <Text style={styles.text}>Register here to start advertising!</Text>
            <ThemeButton
              title="Register"
              variant={'outlined'}
        ...
        {(showRegister || existing === true) && (
          ...
          >
                ...
                children: (
                  <FontAwesome5
                    ...
                    onPress={() => {
                      ...
                      newServiceList.splice(serviceList.indexOf(item), 1);
              ...
              data={petTypeList.map((item) => ({
                ...
                children: (
                  <FontAwesome5
                    ...
                    color={theme.colors.icon}
                    onPress={() => {
                      const newPetTypeList = [...petTypeList];
                      newPetTypeList.splice(petTypeList.indexOf(item), 1);
                ...
                children: (
                  <FontAwesome5
                    ...
                    onPress={() => {
                      ...
                      newPhoneList.splice(phoneList.indexOf(item), 1);
                ...
                children: (
                  <FontAwesome5
                    ...
                    onPress={() => {
                      ...
                      newCityList.splice(cityList.indexOf(item), 1);
            ...
            <Text style={styles.subtitle}>Select the days your are active</Text>
