    ...
    return (
        ...
        >
            <TouchableOpacity
                ...
                style={[styles.filterButton, isFilterSelected('All') && styles.selectedFilterButton]}
            >
                <View style={styles.filterContent}>
                    <Image source={{ uri: petTypeImages['All'] }} style={styles.filterImage} />
                    <Text style={[styles.filterText, isFilterSelected('All') && styles.selectedFilterText]}>All</Text>
                </View>
            </TouchableOpacity>
            {petTypes.map((petType) => (
                <TouchableOpacity
                    ...
                    style={[styles.filterButton, isFilterSelected(petType) && styles.selectedFilterButton]}
                >
                    <View style={styles.filterContent}>
                        <Image
                            source={{
                        ...
                        />
                        <Text style={[styles.filterText, isFilterSelected(petType) && styles.selectedFilterText]}>
                            {petType}
                        </Text>
                    </View>
                </TouchableOpacity>
