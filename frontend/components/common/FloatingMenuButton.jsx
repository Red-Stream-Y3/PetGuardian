...
const FloatingMenuButton = ({ onClick, variant }) => {
  ...
  const styles = StyleSheet.create({
    ...
    pressableContainer: {
      backgroundColor: variant === 'theme' ? tabColor : theme.colors.surface,
      padding: 10,
      borderRadius: 50
    },
    ripple: {
    ...
    iconContainer: {
      transform: [
        {
          rotate: isPressed ? rotateInterpolate : rotateReverseInterpolate
        }
      ]
    }
  });
    ...
    <Animated.View style={styles.container}>
      ...
      >
        <Animated.View style={styles.iconContainer}>
          <AntDesign name="menufold" size={24} color={theme.colors.icon} />
        </Animated.View>
      </Pressable>
    </Animated.View>
  );
