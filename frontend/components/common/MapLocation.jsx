...
const MapLocation = ({ onMarkerChange }) => {
    ...
    const fetchLocation = async () => {
        try {
            ...
            const streetNumber = address[0]?.streetNumber ? `${address[0]?.streetNumber}, ` : '';
            ...
            const formattedAddress = `${streetNumber}${streetName}${city}${country}`.replace(/,\s*$/, '');
            ...
            <View style={styles.mapContainer}>
                <Suspense fallback={<ActivityIndicator />}>
                    ...
                    <View style={styles.gpsButtonContainer}>
                        <TouchableOpacity style={styles.gpsButton} onPress={handleLocateButtonPress}>
                            <MaterialCommunityIcons name="crosshairs-gps" size={22} color="#3c74c2" />
                        </TouchableOpacity>
                    </View>
                </Suspense>
            </View>
