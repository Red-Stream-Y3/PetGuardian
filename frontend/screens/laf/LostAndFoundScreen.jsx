...
import { FoundHome, LostFoundHome, LostHome, LostPost, Post, Profile } from '../../components';
...
const LostAndFoundScreen = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background }}>
            ...
            <LostFoundNavigator.Navigator initialRouteName="LostFoundHome" screenOptions={{ headerShown: false }}>
                <LostFoundNavigator.Screen name="LostFoundHome" component={LostFoundHome} />
