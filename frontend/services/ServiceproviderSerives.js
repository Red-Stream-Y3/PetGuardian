...
export const updateServiceRating = async (data, token) => {
    ...
    const response = await axios.put(`${BASE}/api/v1/ratings/user/${data.user}/${data.serviceProvider}`, data, config);
...
export const getServiceRatingByUser = async (user, id, token) => {
    ...
    const response = await axios.get(`${BASE}/api/v1/ratings/user/${user}/${id}`, config);
...
export const checkBookingTimeAvailability = async (data, token) => {
    ...
    const response = await axios.post(`${BASE}/api/v1/services/hire/check`, data, config);
...
export const createServiceBooking = async (data, token) => {
    ...
    const response = await axios.post(`${BASE}/api/v1/services/hire`, data, config);
...
export const getUserBookings = async (id, token) => {
    ...
    const response = await axios.get(`${BASE}/api/v1/services/hire/${id}`, config);
...
export const getBookingById = async (id, token) => {
    ...
    const response = await axios.get(`${BASE}/api/v1/services/hire/getbyid/${id}`, config);
...
export const cancelBooking = async (data, token) => {
    ...
    const response = await axios.put(`${BASE}/api/v1/services/hire`, data, config);
